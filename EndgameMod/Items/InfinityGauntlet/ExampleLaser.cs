...
namespace EndgameMod.Items.InfinityGauntlet
{
	...
	public class ExampleLaser : ModProjectile // for some reason it wont let me have another name other than ExampleLaser so ok vs.
	{
		...
		private void SpawnDusts(Player player)
		{
			...
			for (int i = 0; i < 2; ++i) {
				...
				Dust dust = Main.dust[Dust.NewDust(dustPos, 147, 112, 219, dustVel.X, dustVel.Y)];
				dust.noGravity = true;
				dust.scale = 1.2f;
		...
		private void ChargeLaser(Player player)
		{
			...
			if (!player.channel) {
				...
				for (int k = 0; k < chargeFact + 1; k++) {
					...
					Dust dust = Main.dust[Dust.NewDust(pos, 147, 112, 219, projectile.velocity.X / 2f, projectile.velocity.Y / 2f)];
